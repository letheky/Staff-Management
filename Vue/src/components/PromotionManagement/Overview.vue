...
export default {
  ...
  methods: {
    ...
    async deleteCircular() {
      await promotion.deleteSeminar(this.deleteCircularID).then(() => {
    ...
    async callDataWithLoading() {
      await promotion.getAllSeminar().then(res => {
        if (res)
    ...
    async create() {
      ...
      await promotion.createSeminar(data).then(() => {
    ...
    async edit() {
      ...
      await promotion.updateSeminar(updateData).then(() => {
