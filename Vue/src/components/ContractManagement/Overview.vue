...
export default {
  ...
  methods: {
    ...
    async deleteCircular() {
      await contract.deleteSeminar(this.deleteCircularID).then(() => {
    ...
    async callDataWithLoading() {
      await contract.getAllSeminar().then(res => {
        if (res)
    ...
    async create() {
      ...
      await contract.createSeminar(data).then(() => {
    ...
    async edit() {
      ...
      await contract.updateSeminar(updateData).then(() => {
