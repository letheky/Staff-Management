    ...
    >
      <template v-slot:body="{ items, headers }">
        ...
        <tr class="fixed-row-filter">
          <th v-for="header in headers" class="abc" :key="header.text">
        ...
        <tfoot>
          <tr>
            ...
            <td></td>
            <td style="text-align: right">{{ filtered.totalDisbursement }}</td>
            <td></td>
            <td></td>
            <td></td>
          </tr>
        ...
        await report_management
          ...
          .then(res => {
            if (res) {
              ...
              this.journalList = res.filter(d => d.entryType.includes('Disbursment'))
